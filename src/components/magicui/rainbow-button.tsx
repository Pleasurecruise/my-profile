...
const rainbowButtonVariants = cva(
  cn(
    "group relative inline-flex shrink-0 cursor-pointer items-center justify-center gap-2 rounded-sm text-sm font-medium whitespace-nowrap outline-none transition-all animate-rainbow",
    "focus-visible:ring-[3px] aria-invalid:border-destructive disabled:pointer-events-none disabled:opacity-50",
