...
export const TweetMedia = ({ tweet }: { tweet: EnrichedTweet }) => {
	...
	const firstVideoVariant = tweet.video?.variants[0];
	return (
		<div className="flex flex-1 items-center justify-center">
			{tweet.video && firstVideoVariant && (
				<video
				...
				>
					<source src={firstVideoVariant.src} type="video/mp4" />
			...
			{!tweet.video &&
				!tweet.photos &&
				// @ts-expect-error - Tweet card structure not fully typed
