import { Timeline, TimelineConnectItem, TimelineItem } from "@/components/cv/timeline";
        ...
        <div className="flex flex-col gap-y-4 items-center justify-center">
          ...
          <div className="flex flex-col gap-y-3 items-center justify-center">
            ...
            <p className="text-muted-foreground md:text-lg/relaxed lg:text-base/relaxed xl:text-lg/relaxed text-balance text-center">
              I&apos;ve attended {DATA.hackathons.length}+ hackathons and loved every experience.
              Building creative projects with motivated people in 24-48 hours is eye-opening and
              exciting.
            </p>
          </div>
        </div>
