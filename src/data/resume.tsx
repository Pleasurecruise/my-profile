...
export const DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      technologies: ["React Native", "Expo", "TypeScript", "Tamagui", "Redux Toolkit"],
      links: [
        {
          type: "Source",
    ...
    },
    {
      ...
      technologies: ["TypeScript", "Node.js", "Python", "MCP", "REST API", "Community Integration"],
      links: [
        {
          type: "Website",
  ...
  contributions: [
    ...
    },
    {
      title: "LobeHub",
      dates: "2025 - Present",
      description: "Open-source community ecosystem for AI-powered tools and extensions.",
    ...
    },
    {
      ...
      dates: "2025 - Present",
      description: "Backend service for the Arknights homework collection site.",
